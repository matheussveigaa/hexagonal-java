...
import br.com.sascar.customer.infrastructure.rest.WebConfiguration;
...
@ComponentScan(basePackageClasses = { MongoDbConfiguration.class, WebConfiguration.class, ApplicationConfiguration.class })
